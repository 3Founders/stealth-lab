...
python -m pytest tests/ -q         # 1505 pass offline (115 more skip without a DB or API keys)
...
```bash
python -m pytest tests/ -q          # 1505 pass offline, no DB needed (115 more skip without one)
```
