...
async def promote_observation_to_claim(
    ...
    *,
    ...
    Parsing a subject/predicate/object out of `label` here would mean
    INVENTING structure that was never separately recorded -- exactly the
    synthetic/fabricated data this codebase's hard rules forbid. Left None
    until a real structured source exists on the Observation itself.
    """
