...
Last updated: 2026-08-25 · Companion to: `verified_procedural_experience_system_ideal_specification_v4.md`, `ARCHITECTURE.md`, `Exec.md`
...
| `check_procedure` | **new** | applicability + preconditions → allow/**structured refusal** |
