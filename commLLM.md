...
| ~~`apply_change_set` ungated~~ | **removed from the public MCP surface** (post-freeze hardening, `v1-final-2026-09-03.1`) | raw write primitive; graph mutation now gated via `submit_approval` / `decide_decomposition` only |
