"""
Step-budget calibration at max_steps=25 (final pre-score remediation,
...
RESULTS_PATH = OUT_DIR / "calibration_max_steps_25_postfix.jsonl"
        ...
        with open(RESULTS_PATH, "a", encoding="utf-8") as outf:
            for task_id, arm in CELLS:
                ...
                record = await run_one_trial(
                    ...
                    max_steps=25, time_budget_s=900,
